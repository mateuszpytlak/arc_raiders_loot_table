import accordion from "@/assets/items/accordion.webp";
import adv_electrical_components from "@/assets/items/adv_electrical_components.webp";
import adv_mechanical_components from "@/assets/items/adv_mechanical_components.webp";
import alarm_clock from "@/assets/items/alarm_clock.webp";
import antiseptic from "@/assets/items/antiseptic.webp";
import apricot from "@/assets/items/apricot.webp";
import arc_alloy from "@/assets/items/arc_alloy.webp";
import arc_circuitry from "@/assets/items/arc_circuitry.webp";
import arc_coolant from "@/assets/items/arc_coolant.webp";
import arc_flex_rubber from "@/assets/items/arc_flex_rubber.webp";
import arc_motion_core from "@/assets/items/arc_motion_core.webp";
import arc_performance_steel from "@/assets/items/arc_performance_steel.webp";
import arc_synthetic_resin from "@/assets/items/arc_synthetic_resin.webp";
import arc_thermo_lining from "@/assets/items/arc_thermo_lining.webp";
import bastion_cell from "@/assets/items/bastion_cell.webp";
import battery from "@/assets/items/battery.webp";
import bicycle_pump from "@/assets/items/bicycle_pump.webp";
import bombardier_cell from "@/assets/items/bombardier_cell.webp";
import broken_flashlight from "@/assets/items/broken_flashlight.webp";
import broken_guidance_system from "@/assets/items/broken_guidance_system.webp";
import broken_handheld_radio from "@/assets/items/broken_handheld_radio.webp";
import broken_taser from "@/assets/items/broken_taser.webp";
import burned_arc_circuitry from "@/assets/items/burned_arc_circuitry.webp";
import camera_lens from "@/assets/items/camera_lens.webp";
import candle_holder from "@/assets/items/candle_holder.webp";
import cat_bed from "@/assets/items/cat_bed.webp";
import coolant from "@/assets/items/coolant.webp";
import cooling_coil from "@/assets/items/cooling_coil.webp";
import cooling_fan from "@/assets/items/cooling_fan.webp";
import cracked_bioscanner from "@/assets/items/cracked_bioscanner.webp";
import crude_explosives from "@/assets/items/crude_explosives.webp";
import crumpled_plastic_bottle from "@/assets/items/crumpled_plastic_bottle.webp";
import damaged_arc_motion_core from "@/assets/items/damaged_arc_motion_core.webp";
import damaged_arc_powercell from "@/assets/items/damaged_arc_powercell.webp";
import damaged_heat_sink from "@/assets/items/damaged_heat_sink.webp";
import damaged_rocketeer_driver from "@/assets/items/damaged_rocketeer_driver.webp";
import deflated_football from "@/assets/items/deflated_football.webp";
import degraded_arc_rubber from "@/assets/items/degraded_arc_rubber.webp";
import diving_goggles from "@/assets/items/diving_goggles.webp";
import dog_collar from "@/assets/items/dog_collar.webp";
import driedout_arc_resin from "@/assets/items/driedout_arc_resin.webp";
import durable_cloth from "@/assets/items/durable_cloth.webp";
import electrical_components from "@/assets/items/electrical_components.webp";
import exodus_modules from "@/assets/items/exodus_modules.webp";
import expired_respirator from "@/assets/items/expired_respirator.webp";
import explosive_compound from "@/assets/items/explosive_compound.webp";
import fireball_burner from "@/assets/items/fireball_burner.webp";
import fried_motherboard from "@/assets/items/fried_motherboard.webp";
import frying_pan from "@/assets/items/frying_pan.webp";
import garlic_press from "@/assets/items/garlic_press.webp";
import headphones from "@/assets/items/headphones.webp";
import hornet_driver from "@/assets/items/hornet_driver.webp";
import household_cleaner from "@/assets/items/household_cleaner.webp";
import humidifier from "@/assets/items/humidifier.webp";
import ice_cream_scooper from "@/assets/items/ice_cream_scooper.webp";
import impure_arc_coolant from "@/assets/items/impure_arc_coolant.webp";
import industrial_battery from "@/assets/items/industrial_battery.webp";
import industrial_charger from "@/assets/items/industrial_charger.webp";
import industrial_magnet from "@/assets/items/industrial_magnet.webp";
import laboratory_reagents from "@/assets/items/laboratory_reagents.webp";
import leaper_pulse_unit from "@/assets/items/leaper_pulse_unit.webp";
import lemon from "@/assets/items/lemon.webp";
import light_bulb from "@/assets/items/light_bulb.webp";
import magnetic_accelerator from "@/assets/items/magnetic_accelerator.webp";
import mechanical_components from "@/assets/items/mechanical_components.webp";
import metal_brackets from "@/assets/items/metal_brackets.webp";
import metal_parts from "@/assets/items/metal_parts.webp";
import motor from "@/assets/items/motor.webp";
import mushroom from "@/assets/items/mushroom.webp";
import number_plate from "@/assets/items/number_plate.webp";
import olives from "@/assets/items/olives.webp";
import polluted_air_filter from "@/assets/items/polluted_air_filter.webp";
import pop_trigger from "@/assets/items/pop_trigger.webp";
import portable_tv from "@/assets/items/portable_tv.webp";
import power_bank from "@/assets/items/power_bank.webp";
import power_cable from "@/assets/items/power_cable.webp";
import power_rod from "@/assets/items/power_rod.webp";
import prickly_pear from "@/assets/items/prickly_pear.webp";
import projector from "@/assets/items/projector.webp";
import radio from "@/assets/items/radio.webp";
import remote_control from "@/assets/items/remote_control.webp";
import ripped_safety_vest from "@/assets/items/ripped_safety_vest.webp";
import rocketeer_driver from "@/assets/items/rocketeer_driver.webp";
import rubber_pad from "@/assets/items/rubber_pad.webp";
import rubber_parts from "@/assets/items/rubber_parts.webp";
import ruined_accordion from "@/assets/items/ruined_accordion.webp";
import ruined_baton from "@/assets/items/ruined_baton.webp";
import ruined_handcuffs from "@/assets/items/ruined_handcuffs.webp";
import ruined_parachute from "@/assets/items/ruined_parachute.webp";
import ruined_riot_shield from "@/assets/items/ruined_riot_shield.webp";
import ruined_tactical_vest from "@/assets/items/ruined_tactical_vest.webp";
import rusted_bolts from "@/assets/items/rusted_bolts.webp";
import rusted_gear from "@/assets/items/rusted_gear.webp";
import rusted_shut_medical_kit from "@/assets/items/rusted_shut_medical_kit.webp";
import rusted_tools from "@/assets/items/rusted_tools.webp";
import rusty_arc_steel from "@/assets/items/rusty_arc_steel.webp";
import sensors from "@/assets/items/sensors.webp";
import sentinel_firing_core from "@/assets/items/sentinel_firing_core.webp";
import snitch_scanner from "@/assets/items/snitch_scanner.webp";
import spotter_relay from "@/assets/items/spotter_relay.webp";
import spring_cushion from "@/assets/items/spring_cushion.webp";
import steel_spring from "@/assets/items/steel_spring.webp";
import surveyor_vault from "@/assets/items/surveyor_vault.webp";
import synthesized_fuel from "@/assets/items/synthesized_fuel.webp";
import syringe from "@/assets/items/syringe.webp";
import tattered_arc_lining from "@/assets/items/tattered_arc_lining.webp";
import tattered_clothes from "@/assets/items/tattered_clothes.webp";
import thermostat from "@/assets/items/thermostat.webp";
import tick_pod from "@/assets/items/tick_pod.webp";
import toaster from "@/assets/items/toaster.webp";
import torn_blanket from "@/assets/items/torn_blanket.webp";
import turbo_pump from "@/assets/items/turbo_pump.webp";
import very_comfortable_pillow from "@/assets/items/very_comfortable_pillow.webp";
import wasp_driver from "@/assets/items/wasp_driver.webp";
import water_filter from "@/assets/items/water_filter.webp";
import water_pump from "@/assets/items/water_pump.webp";
import wires from "@/assets/items/wires.webp";

const itemImages: Record<string, string> = {
    accordion,
    adv_electrical_components,
    adv_mechanical_components,
    alarm_clock,
    antiseptic,
    apricot,
    arc_alloy,
...
// === KEEP FOR QUESTS ===
    ...
    { name: "Broken Taser", category: "Residential", tier: 0.75, value: 2000, group: "Safely Recycle", rarity: "rare" },
    ...
    { name: "Diving Goggles", category: "ARC", tier: 1, value: 640, group: "Safely Recycle", rarity: "rare"  },
